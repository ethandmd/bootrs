...
pub struct StartInfo {
    ...
    pub version: u32,        // == version of this struct
    pub flags: u32,          // SIF_xxx flags
    pub nr_modules: u32,     // number of modules passed to the kernel
    pub modlist_paddr: u32,  // physical address of an array of hvm_modlist_entry
    ...
    pub memmap_paddr: u32,   // physical address of the memory map
